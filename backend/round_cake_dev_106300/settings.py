"""
Django settings for round_cake_dev_106300 project.
...
ROOT_URLCONF = 'round_cake_dev_106300.urls'
...
WSGI_APPLICATION = 'round_cake_dev_106300.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_cake_dev_106300 API",
    "DESCRIPTION": "API documentation for round_cake_dev_106300 App",
    "VERSION": "v1",
}
